...
<div class="modal fade" id="empAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" checked="true" name="gender" id="gender1_add_input" value="M"> 男
                            </label>
                            <label class="radio-inline">
	...
	<script type="text/javascript">
	    ...
	    //构建员工显示列表的tbody部分 result为ajax获取的返回值
	    ...
	    //用户名输入框change时间检验是否可用
	    /* $("#empName_add_input").change(function () {
	    	var empName=this.value;
	    	$.ajax({
	    		uri:"${APP_PATH}/checkuser",
	    		data:"empName="+empName,
	    		type:"POST",
	    		success:function(result){	    			
	    			if(result.code==100){	    				
	    ...
	    $("#emp_updata_btn").click(function () {
	        ...
	        alert($("#empUpdataModal form").serialize());
	        //发送Ajax请求
	        $.ajax({
